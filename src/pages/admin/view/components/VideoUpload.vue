<template>
    <div class="video-upload">
        ...
        <div v-if="modelValue" class="mb-4 relative">
            <video :src="modelValue" controls
                class="w-full h-64 object-cover rounded-xl border-2 border-indigo-200"></video>
        ...
        <div @dragover.prevent @dragleave.prevent @drop.prevent="handleDrop" @click="triggerFileInput"
            ...
            <input ref="fileInput" type="file" accept="video/*" @change="handleFileSelect" class="hidden" />
