        ...
        <div class="bg-slate-50 dark:bg-slate-700 rounded-2xl p-6 border-2 border-slate-200 dark:border-slate-600">
          <div class="flex items-center justify-between mb-6">
            <label class="flex items-center text-lg font-semibold text-slate-700 dark:text-slate-300">
              ...
              Nearby Attractions
              <span class="ml-2 text-sm text-slate-500 dark:text-slate-400 font-normal">({{ locationForm.attractions.length }} attractions)</span>
            </label>
            <button
              type="button"
              @click="addAttraction"
          ...
          <div class="space-y-6">
            ...
            >
              ...
              <div class="flex items-center justify-between mb-6 pb-4 border-b border-slate-200 dark:border-slate-700">
                <div class="flex items-center space-x-3">
                  <div class="w-10 h-10 bg-linear-to-br from-emerald-100 to-teal-100 dark:from-emerald-900/20 dark:to-teal-800/20 rounded-lg flex items-center justify-center">
                  ...
                  <div>
                    <h4 class="text-lg font-bold text-slate-900 dark:text-slate-100">{{ attraction.name || `Attraction ${index + 1}` }}</h4>
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <!-- Name -->
                <div>
                  <label class="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-2">Attraction Name</label>
                  <input
                ...
                <!-- Distance -->
                <div>
                  <label class="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-2">Distance from Hotel</label>
                  <input
          ...
          <div v-if="locationForm.attractions.length === 0" class="text-center py-12">
            ...
            <p class="text-slate-600 dark:text-slate-400 mb-6">Start building your location section by adding nearby attractions and points of interest</p>
            <button
              type="button"
              @click="addAttraction"
