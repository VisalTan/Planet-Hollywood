          ...
          <div class="space-y-3">
            ...
            >
              ...
              <button 
                ...
                class="flex-shrink-0 w-10 h-10 flex items-center justify-center text-slate-400 hover:text-red-600 hover:bg-red-50 rounded-lg transition-all duration-200 opacity-0 group-hover/tag:opacity-100"
              >
